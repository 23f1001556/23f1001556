<p align="center">
  <img src="https://readme-typing-svg.demolab.com/?font=Fira+Code&size=30&duration=3500&pause=1000&color=7928CA&center=true&vCenter=true&width=700&height=60&lines=Hi+there,+I%27m+Sidhant+Kumar;Software+Engineer;Backend+Specialist;AI+Applications" alt="Typing SVG" />
</p>
...
![React (Next.js)](https://img.shields.io/badge/React_(Next.js)-61DAFB?style=flat-square&logo=react&logoColor=black)

#### 🧠 Generative AI
![LangChain](https://img.shields.io/badge/LangChain-1C3C3C?style=flat-square) 
![RAG Systems](https://img.shields.io/badge/RAG_Systems-FF5722?style=flat-square) 
![LLM Applications](https://img.shields.io/badge/LLM_Applications-8E75C2?style=flat-square) 
![Embeddings](https://img.shields.io/badge/Embeddings-0052CC?style=flat-square) 
![ChromaDB](https://img.shields.io/badge/ChromaDB-0052CC?style=flat-square) 
![Google Gemini API](https://img.shields.io/badge/Google_Gemini_API-8E75C2?style=flat-square&logo=google-gemini&logoColor=white) 
![Prompt Engineering](https://img.shields.io/badge/Prompt_Engineering-009688?style=flat-square)

---

<h3 align="center">🚀 What I've Built & Deployed</h3>
...
<table width="100%">
  <thead>
    <tr>
      ...
      <th width="23%" align="left">Tech Stack</th>
      <th width="12%" align="left">Links</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td valign="top">
        <strong>BS Connect Platform</strong><br/>
        <small>Sept 2025 - Jan 2026</small>
      </td>
      <td valign="top">
        Professional networking platform serving 150+ users in the IIT Madras BS community.
        <ul>
          <li>Developed Spring Boot REST APIs with Google OAuth2 & Redis session management.</li>
          <li>Resolved N+1 DB bottlenecks and set up caching.</li>
          <li>Deployed to Oracle Cloud via Nginx.</li>
        </ul>
      </td>
      <td valign="top">
    ...
    <tr>
      <td valign="top">
        <strong>AI Assessment Platform</strong><br/>
        <small>Sept 2025 - Jan 2026</small>
      </td>
      <td valign="top">
        Multi-tenant online assessment SaaS with strict isolation.
        <ul>
          <li>Configured schema isolation and Role-Based Access Control (RBAC).</li>
          <li>Built automated quiz generator using Google Gemini API (structured assessments from PDFs, text, and images).</li>
        </ul>
      </td>
      <td valign="top">
    ...
    <tr>
      <td valign="top">
        <strong>Enterprise Knowledge intelligence Assistant</strong><br/>
        <small>Jul 2026</small>
      </td>
      <td valign="top">
        Retrieval-Augmented Generation (RAG) assistant enabling Q&A over files.
        <ul>
          <li>Built dynamic text chunking and vector search via ChromaDB and LangChain.</li>
          <li>Designed Flask REST APIs with latency tracking logs.</li>
        </ul>
      </td>
      <td valign="top">
        <img src="https://img.shields.io/badge/Flask-000000?style=flat-square&logo=flask&logoColor=white" /><br/>
        <img src="https://img.shields.io/badge/LangChain-1C3C3C?style=flat-square" /><br/>
        <img src="https://img.shields.io/badge/ChromaDB-0052CC?style=flat-square" /><br/>
        <img src="https://img.shields.io/badge/Gemini-8E75C2?style=flat-square&logo=google-gemini&logoColor=white" />
      </td>
      <td valign="top">
        <a href="https://github.com/23f1001556/enterprise-knowledge-assistant"><img src="https://img.shields.io/badge/GitHub-181717?style=flat-square&logo=github" alt="GitHub" /></a>
      </td>
    </tr>
  </tbody>
</table>
...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=23f1001556&color=7928CA&style=flat-square&label=Profile+Views" alt="Profile Views" />
</p>
